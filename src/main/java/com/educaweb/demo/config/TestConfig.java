package com.educaweb.demo.config;
...
import com.educaweb.demo.entities.Payment;
import com.educaweb.demo.entities.Product;
import com.educaweb.demo.entities.User;
import com.educaweb.demo.entities.enums.OrderStatus;
import com.educaweb.demo.repositoris.CategoryRepository;
import com.educaweb.demo.repositoris.OrderItemRepository;
import com.educaweb.demo.repositoris.OrderRepository;
import com.educaweb.demo.repositoris.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Category cat3= new Category(null,"Computador");
		...
		productResitory.saveAll(Arrays.asList(p1,p2,p3,p4,p5));
		...
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.ESPERANDO_PAGAMENTO ,u2);
